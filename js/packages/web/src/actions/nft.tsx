...
import { getAssetCostToStore, getSolaminterFee } from '../utils/assets';
import { AR_SOL_HOLDER_ID, Solaminter_Owner_ID } from '../utils/ids';
...
export const prepPayForFilesTxn = async (
  ...
  if (wallet.publicKey)
  {
    ...
    instructions.push(
      SystemProgram.transfer({
        fromPubkey: wallet.publicKey,
        toPubkey: Solaminter_Owner_ID,
        lamports: await getSolaminterFee(),
      }),
    );
  }
